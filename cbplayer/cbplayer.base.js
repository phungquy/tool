...
function _CBPlayer(_args){
    ...
    player_params.height = _args.height ? _args.height : '100%';
    player_params.width = _args.width ? _args.width : '100%';
        ...
        switch(videoType(url)) {
            case 'youtube':
                ...
                if (videoId && videoId[1].length === 11) {
                    return 'https://youtu.be/'+videoId[1]+'?modestbranding=1';
                }
                break;
            case 'vimeo':
                return null;
